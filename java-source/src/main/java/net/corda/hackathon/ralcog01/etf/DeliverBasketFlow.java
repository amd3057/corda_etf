...
public class DeliverBasketFlow extends OrderBaseFlow {
    ...
    public DeliverBasketFlow(Basket basket, Party newOwner) {
        this.basket = basket;
    ...
    public SignedTransaction call() throws FlowException {
        ...
        Basket newBasket = new Basket(this.basket.getIssuer(), this.newOwner, this.basket.getProducts(), this.basket.getReqProduct(), this.basket.getLinearId());
